...
<header class="top-0 sticky ">
    <div class="navbar md:h-[100px] ">
        <div class="flex-1">
            <div class="md:pt-16 md:pl-10 pl-2 pt-2 flex">
                <img src="/logolanyard.png" alt="logo" srcset="" class="md:w-20 w-14  shadow-text-white drop-shadow-lg">
                <h1 class="janei md:pt-3 md:pl-5 pt-1 pl-2 md:text-[30px] text-[25px] font-bold text-black ">JANEI</h1>
            </div>
        </div>
